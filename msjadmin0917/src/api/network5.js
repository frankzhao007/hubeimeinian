...
if (process.env.NODE_ENV == "development") {
    ...
    instance1.defaults.baseURL = "https://whiot.ihaozhuo.com/mnCMCalc"; //武汉测试环境
    // instance1.defaults.baseURL = "https://hbmnmsj.ihaozhuo.com/mnCMCalc"; //武汉开发环境
...
export function post(url, data, cid) {
...
export function get(url, data, cid) {
    console.log(url, data)
    return new Promise((resolve, reject) => {
        instance1({
            method: 'get',
