<template>
  ...
  <div style="margin:20px">
    ...
    <el-table :data="tableData" style="width: 100%;margin-top:20px" v-loading="loadings">
      <el-table-column prop="paperOrderNumber" label="纸单编号" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="orderDate" label="单子年份" min-width="140" show-overflow-tooltip></el-table-column>
      ...
      <el-table-column prop="marketingDepartment" label="营销部" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="saleDepartment" label="销售部" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="remark" label="备注" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="DWDM" label="单位代码" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="DWMC" label="单位" min-width="200" show-overflow-tooltip></el-table-column>
      <el-table-column prop="appointmentDate" label="预约日期" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="appointmentAt" label="预约生成日期" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column
        prop="lastAppointmentDate"
        label="最后一个集中预约日期"
        min-width="180"
        show-overflow-tooltip
      ></el-table-column>
      <!-- <el-table-column prop="receiptDate" label="回款日期" min-width="140" show-overflow-tooltip></el-table-column> -->
      <el-table-column prop="totalOriginalPrice" label="原价合计" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="totalReturn" label="回款合计" min-width="140" show-overflow-tooltip></el-table-column>
      <!-- <el-table-column prop="addPackageCost" label="加项" min-width="140" show-overflow-tooltip></el-table-column> -->
      ...
      <!-- <el-table-column label="逾期天数" min-width="140" show-overflow-tooltip>
        <template slot-scope="scope">
          <div class="resAnd">
            <div v-for="(item,indexz) in scope.row.returnCycle" :key="indexz">
              <div>{{item.overdueDays}}</div>
            </div>
          </div>
        </template>
      </el-table-column>-->
      <el-table-column prop="invoicedAmount" label="开票金额" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="invoiceDiff" label="发票高开金额" min-width="140" show-overflow-tooltip>
        <template slot-scope="scope">
          <el-tooltip
            class="item"
            effect="dark"
      ...
      <el-table-column prop="saleSpend" label="销售费用" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="fare" label="租车费" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="paidInAmount" label="实收金额" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="headcount" label="体检人数" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="pericePerPerson" label="平均单价" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="discountRatio" label="平均折扣率" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="commissionRatio" label="提成比例" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="rewardRatio" label="奖励比例" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="commissionAmount" label="提成金额" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="lateFeeReceivable" label="应收滞纳金" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column
        prop="dingdingLateRemark"
        label="钉钉审批延期时间"
        min-width="140"
        show-overflow-tooltip
      ></el-table-column>
      <el-table-column prop="deduction" label="扣款" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column prop="hrDeduction" label="人事扣款" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column
        ...
        show-overflow-tooltip
      ></el-table-column>
      <el-table-column prop="cooperationOrder" label="合作单" min-width="140" show-overflow-tooltip></el-table-column>
      <el-table-column
