  ...
  <div class="app-container" style="padding-top:0px;padding-right:100px">
    ...
    <div style="margin:10px 0 10px 25px">
      ...
      <el-table :data="[orderobj]" style="width: 100%" border>
        <el-table-column prop="orNumber" label="订单编号" min-width="160"></el-table-column>
        <el-table-column prop="goSonNumber" label="子订单编号" min-width="250"></el-table-column>
        <el-table-column prop="payWaterNumber" label="支付流水号" min-width="210"></el-table-column>
      ...
      <el-table :data="[orderobj]" style="width: 100%" border>
        ...
        <el-table-column prop="goodsType" label="商品类型" min-width="460"></el-table-column>
        <!-- <el-table-column prop="userName" label="购买人姓名" min-width="210"> </el-table-column> -->
    ...
    <div style="margin:10px 0 10px 25px" v-if="orderobj.goodsType=='电子体检卡'">
      ...
      <el-button style="float:right" type="primary" @click="changecardmsg('修改卡密')" v-else>修改卡密</el-button>
      <div style="line-height:40px">
        卡密信息：
      </div>
      <el-table :data="[orderobj]" style="width: 100%" border>
    ...
    <div style="margin:10px 0 10px 25px">
      ...
      <el-table :data="[orderobj]" style="width: 100%" border>
        ...
        <el-table-column prop="goodsDeduction" label="权益抵扣"></el-table-column>
