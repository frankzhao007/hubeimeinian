  ...
  <div class="app-container" style="position:relative">
    ...
    <el-form size="medium" :model="AddProject" :rules="AddProjectrules" label-width="120px" ref="AddProject" style="margin-top:30px;position:relative">
      ...
      <el-form-item label="门市价：" prop="AddProjectiPrice">
        <el-input v-model="AddProject.AddProjectiPrice" maxlength="6" @input="AddProjectiPriceinput()" style="width:200px" placeholder="点击输入0~100000正整数"></el-input>
      </el-form-item>
      <el-form-item label="核算价：" prop="AddProjectAccountingPrice">
        <el-input v-model="AddProject.AddProjectAccountingPrice" @input="AddProjectAccountingPriceinput()" maxlength="6" style="width:200px" placeholder="点击输入0~100000正整数"></el-input>
      </el-form-item>
    ...
    if (this.$route.query.ischange == "true") {
      ...
      this.$api.post("/manage/manageQueryCheckById", body).then(res => {
        ...
        if (res.code == "200") {
          ...
          this.AddProject.AddProjectiPrice = res.data.checkprice;
          this.AddProject.AddProjectAccountingPrice = res.data.checklowprice;
...
//      }
        this.$api
          .post("/manage/insertWeiBaoCheck", body)
          .then(res => {
            if (res.code == "200") {
              this.$message({
                message: "创建成功",
    ...
    ChangProjectBtn() {
      ...
      if (this.inputverify()) {
        ...
        this.$api
          .post("/manage/updateWeiBaoCheck", body)
          .then(res => {
            console.log(res);
            if (res.code == "200") {
              this.$message({
